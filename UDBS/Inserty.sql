/*TEST*//*1 pøidejte do tabulky zakaznik atribut vek typu integer, který nemùže být NULL. Všem souèasným zákazníkùm v databázi nastavte hodnotu atributu na 20. (4 body)
-- 2 vymažte zákazníka se jménem 'pepík'. (4 body)
-- 3 Pøidejte tabulku výrobce (znacka: varchar, telefon:varchar) , kde atribut znacka bude primárním klíèek (6 bodù)
-- 4 udìlejte z atributu Produkt.znacka cizí klíè na tabulku Vyrobce. (6 bodù)*//*1 Pridani veku do tabulky s defaultni hodnotou atributu 20*/ALTER TABLE test.Zakaznik ADD vek int NOT NULL Default 20 /*2 Vymazani zakaznika z tabulek*/delete from test.reklamace where nID
